...
type ComponentProps = BoxProps & AddedProps;

const StyledBox = styled("div")<ComponentProps>`
...
export const Box: React.FC<BoxProps> = function Box(props: BoxProps) {
  const { children, variant, component, ...rest } = props;
  return (
    <StyledBox variant={variant} as={component || "div"} {...rest}>
      {children}
    </StyledBox>
  );
};
